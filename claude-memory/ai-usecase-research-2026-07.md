...
- **Top plays (Tier 1):** reverse-prompt audit of Kenny's day → lapsed-customer reactivation over 25-yr order history (Ben AI demonstrated blueprint) → speed-to-lead with mockup in first reply → GrowthEngineX cold-outbound Claude Code skills (github.com/growthenginenowoslawski/coldoutboundskills, verified; SmartLead upload only, NO warmup/inbox skills) + Saraev site-crawl personalization ending in a custom mockup.
