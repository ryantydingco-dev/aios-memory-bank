...
**PII note:** fresh AI Ark lead pulls go to `outputs/ca-outbound/` which is now gitignored. Pre-existing: `outputs/gtm-sprint-2026-07-06/reorder-rescue-call-list.csv` (117 customer contacts) IS tracked in the private CA repo — legitimate synced business data, but be aware it's in git. Related: [[ai-usecase-research-2026-07]], [[creative-alternatives-aios]], [[two-machine-sync]].
